 ...
 */
function formulaires_supprimer_mosaic_charger_dist($id_mosaic){
	$valeurs = array(
		'id_mosaic' => $id_mosaic
	);
	return $valeurs;
 ...
 *     Tableau des erreurs
 */
function formulaires_supprimer_mosaic_verifier_dist($id_mosaic){
	$erreurs = array(
	);
	return $erreurs;
}
 ...
 */
function formulaires_supprimer_mosaic_traiter_dist($id_mosaic){
	$statut= "poubelle";
