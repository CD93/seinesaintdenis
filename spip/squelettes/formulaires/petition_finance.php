 ...
 * @return array
 */
function formulaires_petition_finance_charger_dist(){
	$valeurs = array(
 ...
 * @return array
 */
function formulaires_petition_finance_verifier_dist(){
	$erreurs = array();
 ...
 * @return array
 */
function formulaires_petition_finance_traiter_dist(){
	...
	sql_insertq('petition_finance', array(
			'nom' => $nom, 
			'prenom' => $prenom,
			'email' => $email,
			'ville' => $ville,
